<?php
    ...
    try {
        ...
        $sql = "UPDATE users SET fname=:fname,lname=:lname,age=:age,mobile=:mobile,email=:email,department=:department,uni=:uni,mats1=:mats1,mats2=:mats2,mats3=:mats3,mats1_g=:mats1_g,
                        mats2_g=:mats2_g,mats3_g=:mats3_g,inters1=:inters1,inters2=:inters2,inters3=:inters3,inters1_g=:inters1_g,inters2_g=:inters2_g,inters3_g=:inters3_g,bachs1=:bachs1,
                        bachs2=:bachs2,bachs3=:bachs3,bachs1_g=:bachs1_g,bachs2_g=:bachs2_g,bachs3_g=:bachs3_g,experience=:experience,award=:award,s1_name=:s1_name,s1_year=:s1_year,s1_desc=:s1_desc,
                        s2_name=:s2_name,s2_year=:s2_year,s2_desc=:s2_desc,s3_name=:s3_name,s3_year=:s3_year,s3_desc=:s3_desc,profile=:profile,objective=:objective,lang1=:lang1,lang2=:lang2,lang3=:lang3,
                        hobby1=:hobby1,hobby2=:hobby2,hobby3=:hobby3,ref_name=:ref_name,ref_cont=:ref_cont,ref_add=:ref_add WHERE ID=:ID";
